...
public interface EndpointHandler {
    ...
    default REST.Response executeMethod(
        ...
        switch (request.getMethod()) {
            ...
            default:
                throw new RestEndpointException(HTTPStatusCodes.METHOD_NOT_ALLOWED, "unimplemented");
        }
    }
    ...
    default REST.Response executeGET(
            Context context,
            URI requestURI,
            REST.Request<UniNode> request, String[] urlParams) throws RestEndpointException {
    ...
    interface Underlying extends EndpointHandler {
        ...
        @Override
        default REST.Response executeMethod(Context context, URI requestURI, REST.Request request, String[] urlParams) throws RestEndpointException {
